...
- Smart auto-detection of media type from TMDB ID
- Official YouTube trailer in a sleek full-screen modal
- Fully responsive design — looks perfect on mobile, tablet, and desktop
- Clean, performant architecture with modern React practices
